...
f_layer = FuzzyLayer(fuzzy_kernels, initializer_centers=lambda x: np.transpose(np.array([x_train[i] for i in indices])), input_shape = (2 * slice, 1))
